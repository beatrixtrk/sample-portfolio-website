    ...
    return (
        <section className='lg:min-h-[100vh] pb-12 lg:py-24'>
            <div className='container mx-auto'>
                <h2 className='section-title mb-8 lg:mb-16 text-center mx-auto'>About me</h2>
                    ...
                    <div className="flex-auto">
                        <Tabs defaultValue="personal">
                            <TabsList className="w-full grid p-[4px] lg:grid-cols-3 lg:max-w-[520px] lg:border dark:border-none">
                                <TabsTrigger className="w-[162px] lg:w-auto" value="personal">Personal Info</TabsTrigger>
                                <TabsTrigger className="w-[162px] lg:w-auto" value="qualification">Qualifications</TabsTrigger>
                                <TabsTrigger className="w-[162px] lg:w-auto" value="skills">Skills</TabsTrigger>
                            </TabsList>
                            <div className="text-lg mt-12 lg:mt-8">
                                {/* Personal tab */}
                                <TabsContent value="personal">
                                    <div className="tetx-center lg:text-left">
                                        <h3 className="h3 mb-4">Over 6 years experience</h3>
                                        <p className="subtitle max-w-xl mx-auto lg:mx-0">As an enthusiastic junior frontend developer, I am eager to engage in innovative and challenging projects. My passion is to creat and enhanc unique digital experiences for users in the online space. I am adaptable and a quick learner, always open to exploring new technologies and methodologies.</p>
                                        <div className="grid lg:grid-cols-2 gap-4 mb-12">
                                            {infoData.map((item, index) => {
                                                return (
                                                    <div className="flex items-center gap-x-4 mx-auto lg:mx-0" key={index}>
                                ...
                                <TabsContent value="qualification">
                                    <div>
                                        <h3 className="h3 mb-4">My Awesome Journey</h3>
